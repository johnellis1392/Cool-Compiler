...
class programc extends Program {
    ...
    */
	...
	// Enumerate over all classes in class list and semant them
	for(Enumeration e=classes.getElements(); e.hasMoreElements();) {
	    ((class_c) e.nextElement()).semant(objectTable,
					      methodTable,
					      classTable);
	}


	// Take another pass over tree to enforce type checking;
	// If a type error occurs, call dump with type method on
	// object in err
	// TODO: Create Typecheck method in AST constructors
...
class class_c extends Class_ {
	...
	for(Enumeration e=features.getElements(); e.hasMoreElements();) {
	    ...
	    feature.semant(objectTable, methodTable, classTable, this);
	}
    }
}
...
class method extends Feature {
    ...
    public void semant(SymbolTable objectTable,
		       ...
		       class_c c) {
	for(Enumeration e=formals.getElements(); e.hasMoreElements();) {
	    ((Formal) e.nextElement()).semant(objectTable,
					      methodTable,
					      classTable,
					      c);
	}
...
class new_ extends Expression {
    ...
    public void semant(SymbolTable objectTable,
		       ...
		       SymbolTable classTable,
		       class_c c) {
	class_c symbolClass = (class_c) classTable.lookup(type_name);
	set_type(symbolClass.getName());
    }
}
